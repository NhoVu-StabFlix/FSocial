...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pid', shortuuid.django_fields.ShortUUIDField(alphabet='0123456789', length=11, max_length=25, prefix='1000')),
                ('cover_image', models.ImageField(default='cover.jpg', upload_to=userauths.models.user_directory_path)),
                ('images', models.CharField(default='default.jpg', max_length=200, verbose_name=userauths.models.user_directory_path)),
                ('full_name', models.CharField(blank=True, max_length=200, null=True)),
                ('bio', models.CharField(blank=True, max_length=200, null=True)),
                ('phone', models.CharField(blank=True, max_length=200, null=True)),
                ('gender', models.CharField(choices=[('male', 'Male'), ('female', 'Female')], default='Male', max_length=200)),
                ('relationship', models.CharField(choices=[('signle', 'Single'), ('married', 'Married')], default='Single', max_length=200)),
