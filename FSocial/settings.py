...
SECRET_KEY = 'django-insecure-1g2pm&5m-ipo=5+&aunmj@$n+vp+po6#k9%^m00&wlp%2122-_'
...
WSGI_APPLICATION = 'FSocial.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to FScocial, Login Now.",
    "topmenu_links": [
